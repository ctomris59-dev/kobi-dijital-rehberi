...
const SIZES = [
  ...
  { id: "orta", label: "Orta Ölçekli İşletme", sub: "50–249 Çalışan", desc: "Kurumsallaşmış yapı; entegre ERP/CRM, veri güvenliği ve gelişmiş iş zekasi ihtiyacı." },
];
...
/* ---------------------------------------------------------
   ANA UYGULAMA (FORCE DARK SAAS THEME)
--------------------------------------------------------- */
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0F172A", color: "#F8FAFC", fontFamily: "system-ui, -apple-system, sans-serif", margin: 0, padding: 0 }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        body, #root { background-color: #0F172A !important; color: #F8FAFC !important; margin: 0; padding: 0; }
        @media print {
        ...
        <div style={{ background: "linear-gradient(180deg, #1E293B 0%, #0F172A 100%)", borderBottom: "1px solid #334155", padding: "56px 24px", textAlign: "center" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "15px", color: "#94A3B8", lineHeight: "1.6", marginBottom: "32px" }}>
              ...
              dijitalleşme seviyenizi ölçün; bütçenize uygun somut araç ve yazılım önerilerini hemen edinin.
            </p>
            <button
              onClick={goNext}
